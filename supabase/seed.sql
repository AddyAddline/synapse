-- ============================================
-- Seed: All 25 lessons across 5 phases
...
-- ============================================
-- Lesson 21: Exploring Real Spike Data
-- ============================================
INSERT INTO lessons (id, phase, order_num, title, description, difficulty, estimated_minutes, content_md)
VALUES (21, 5, 1, 'Exploring Real Spike Data',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (21, 1, 'Load and inspect spike data',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (21, 2, 'Compute firing rates across trials',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (21, 3, 'Plot a neural tuning curve',
...
-- ============================================
-- Lesson 22: Real EEG: Steady-State Visual Evoked Potentials
-- ============================================
INSERT INTO lessons (id, phase, order_num, title, description, difficulty, estimated_minutes, content_md)
VALUES (22, 5, 2, 'Real EEG: Steady-State Visual Evoked Potentials',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (22, 1, 'Load and inspect SSVEP EEG data',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (22, 2, 'Compute the power spectrum of real EEG',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (22, 3, 'Compare power spectra across channels',
...
-- ============================================
-- Lesson 23: Working with fMRI Data
-- ============================================
INSERT INTO lessons (id, phase, order_num, title, description, difficulty, estimated_minutes, content_md)
VALUES (23, 5, 3, 'Working with fMRI Data',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (23, 1, 'Load and inspect fMRI data',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (23, 2, 'Extract and plot an ROI time series',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (23, 3, 'Correlate fMRI signal with task design',
...
-- ============================================
-- Lesson 24: Calcium Imaging: Watching Neurons Fire
-- ============================================
INSERT INTO lessons (id, phase, order_num, title, description, difficulty, estimated_minutes, content_md)
VALUES (24, 5, 4, 'Calcium Imaging: Watching Neurons Fire',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (24, 1, 'Load and inspect calcium imaging data',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (24, 2, 'Compute dF/F and visualize traces',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (24, 3, 'Detect calcium transients',
...
-- ============================================
-- Lesson 25: Cross-Modal Neuroscience Capstone
-- ============================================
INSERT INTO lessons (id, phase, order_num, title, description, difficulty, estimated_minutes, content_md)
VALUES (25, 5, 5, 'Cross-Modal Neuroscience Capstone',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (25, 1, 'Multi-modal data inventory',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (25, 2, 'Cross-modal analysis comparison',
...
INSERT INTO exercises (lesson_id, order_num, title, prompt, starter_code, solution, hints, test_cases, requires_plot)
VALUES (25, 3, 'Final capstone visualization',
